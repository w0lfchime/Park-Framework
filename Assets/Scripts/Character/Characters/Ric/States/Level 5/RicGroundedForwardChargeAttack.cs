...
public class RicGroundedForwardChargeAttack : GroundedChargeAttackState
{
    //Level x state
    ...
    //=//-----|Setup|----------------------------------------------------//=//
    #region setup
    public RicGroundedForwardChargeAttack(PerformanceCSM sm, Character character) : base(sm, character)
    {
        //...
        ...
        animationOriginalFrameDuration = 30;
